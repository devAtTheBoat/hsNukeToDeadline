...
class HS_DeadlineDialog( nukescripts.PythonPanel ):
    def __init__( self, maximumPriority, pools, secondaryPools, groups ):
        ...
        self.jobTab = nuke.Tab_Knob( "Deadline_JobOptionsTab", "Job Options DEV" )
...
def SubmitToDeadline( ):
    ...
    ##########################################################################################
    ## Hovering Sombrero Environments
    ##########################################################################################

    hs_job = os.environ["JOB"]
    hs_deliveryColorSpace = os.environ[hs_job + "_deliveryColorSpace"]
    hs_defaultPadding = os.environ[hs_job + "_defaultPadding"]
    hs_dailiesResolution = os.environ[hs_job + "_dailiesResolution"]
    hs_defaultVersionPath = os.environ[hs_job + "_defaultVersionPath"]
    hs_deliveryResolution = os.environ[hs_job + "_deliveryResolution"]
    hs_defaultLutPath = os.environ[hs_job + "_defaultLutPath"]
    hs_clientSendCodec = os.environ[hs_job + "_clientSendCodec"]
    hs_dailiesCodec = os.environ[hs_job + "_dailiesCodec"]
    hs_deliveryFileFormat = os.environ[hs_job + "_deliveryFileFormat"]
    hs_clientSendResolution = os.environ[hs_job + "_clientSendResolution"]
    hs_projectionAspectRatio = os.environ[hs_job + "_projectionAspectRatio"]

    print hs_deliveryColorSpace
    print hs_defaultPadding
    print hs_dailiesResolution
    print hs_defaultVersionPath
    print hs_deliveryResolution
    print hs_defaultLutPath
    print hs_clientSendCodec
    print hs_dailiesCodec
    print hs_deliveryFileFormat
    print hs_clientSendResolution
    print hs_projectionAspectRatio
